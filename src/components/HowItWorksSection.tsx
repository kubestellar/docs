...
export default function HowItWorksSection() {
  ...
  return (
    <section id="how-it-works" className="relative py-16 bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 text-white overflow-hidden">
      {/* Dark base background */}
      <div className="absolute inset-0 bg-[#0a0a0a]"></div>
      
      {/* Starfield background */}
      <div id="stars-container-how" className="absolute inset-0 overflow-hidden"></div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="text-center mb-16">
          ...
          <p className="mt-4 max-w-2xl mx-auto text-xl text-gray-300">
            Three simple steps to transform your multi-cluster Kubernetes operations
          </p>
        </div>
              ...
              <div className="md:w-1/2 md:pr-12">
                <div className="relative">
                  ...
                  <p className="text-gray-300 mb-6 leading-relaxed">
                    Use standard Kubernetes manifests with KubeStellar annotations to specify placement 
                    policies, resource requirements, and distribution preferences.
                  </p>
                  <div className="bg-gray-800/50 backdrop-blur-sm rounded-lg p-4 border border-gray-700/50">
                    <div className="text-xs text-gray-400 mb-2">workload.yaml</div>
            ...
            <div className="flex flex-col md:flex-row-reverse items-center">
              <div className="md:w-1/2 md:pl-12">
                <div className="relative">
                  ...
                  <p className="text-gray-300 mb-6 leading-relaxed">
                    KubeStellar's intelligent engine analyzes cluster capacity, network topology, 
                    and policy constraints to determine optimal workload placement across your infrastructure.
                  </p>
                  <div className="grid grid-cols-2 gap-4">
                    <div className="bg-green-500/10 backdrop-blur-sm rounded-lg p-3 border border-green-500/30">
                      <div className="text-green-400 text-sm font-medium">US-East Cluster</div>
                      <div className="text-xs text-gray-400">✓ Policy Match</div>
                    </div>
                    <div className="bg-blue-500/10 backdrop-blur-sm rounded-lg p-3 border border-blue-500/30">
                      <div className="text-blue-400 text-sm font-medium">EU-West Cluster</div>
            ...
            <div className="flex flex-col md:flex-row items-center">
              <div className="md:w-1/2 md:pr-12">
                <div className="relative">
                  ...
                  <p className="text-gray-300 mb-6 leading-relaxed">
                    Workloads are automatically deployed to selected clusters with continuous monitoring, 
                    health checks, and automatic failover capabilities for maximum reliability.
                  </p>
                  <div className="flex items-center space-x-4">
                    <div className="flex items-center space-x-2">
                      <div className="w-3 h-3 bg-green-500 rounded-full animate-pulse"></div>
                      <span className="text-sm text-green-400">5 Clusters Active</span>
                    </div>
                    <div className="flex items-center space-x-2">
