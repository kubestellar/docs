      ...
      <div className="relative z-10 max-w-7xl mx-auto px-8 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-12 md:grid-cols-12 mb-12 items-start gap-1 sm:gap-6">
          ...
          <div className="col-span-2 sm:col-span-6 lg:col-span-3 sm:order-2 lg:order-6 md:ml-12 lg:ml-0 mt-4 sm:mt-0" >
            <h3 className={`text-sm font-semibold uppercase tracking-wider sm:mt-3 md:mt-2 lg:mt-1 mb-4 text-center ${
              isDark ? 'text-white' : 'text-gray-900'
            }`}>
              Stay Updated
            </h3>
            <div className={`backdrop-blur-md rounded-lg p-4 border transform transition-all duration-300 ${
              isDark
                ? 'bg-gray-800/50 border-gray-700/50 hover:border-blue-500/30'
                : 'bg-white/50 border-gray-300 hover:border-blue-400/50'
            }`}>
              <form id="newsletter-form" className="flex flex-col space-y-3">
                <div className="relative">
                  ...
                  <input
                    id="email-address"
                    type="email"
                    className={`block w-full pl-10 pr-3 py-2 text-sm rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors duration-200 ${
                      isDark
                ...
                <button
                  type="submit"
                  className={`w-full px-4 py-2 text-sm font-medium text-white bg-gradient-to-r from-blue-600 to-purple-600 border border-transparent rounded-md shadow-sm hover:from-blue-700 hover:to-purple-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-all duration-200 transform hover:translate-y-[-1px] flex items-center justify-center cursor-pointer ${
