...
export default function SelectDropdown({
  ...
  // computed style/class for fixed width
  ...
  return (
    <div className={rootClass} ref={dropdownRef} data-dropdown style={widthStyle}>
      <button
        ...
        // set a fixed height so vertical size is stable
      ...
      >
        {/* label container — truncate to fixed width */}
        <span
      ...
      {/* keep DOM presence and let isOpen + hook coordinate */}
      <div
      ...
      >
        {options.map(option => (
          <a
            ...
            title={option.label} // full label on hover for long labels
          >
            {option.label}
          </a>
        ))}
