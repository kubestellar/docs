          ...
          container.addEventListener("mouseenter", () => {
            ...
            dropdownContainers.forEach(otherContainer => {
              if (otherContainer !== container) {
                const otherMenu = otherContainer.querySelector<HTMLElement>("[data-dropdown-menu]");
          ...
          <div className="hidden md:flex flex-1 justify-center">
            <div className="flex items-center space-x-8">
              ...
              <div className="relative group">
                <a href="#docs" className="text-sm font-medium text-gray-300 hover:text-blue-400 transition-all duration-300 flex items-center space-x-1 px-3 py-2 rounded-lg hover:bg-blue-500/10 hover:shadow-lg hover:shadow-blue-500/20 nav-link-hover">
                  <div className="relative">
                    <svg className="w-5 h-5 transition-all duration-300 group-hover:scale-102" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="relative group">
                ...
                <a href="https://kubestellar.medium.com/list/predefined:e785a0675051:READING_LIST" className="text-sm font-medium text-gray-300 hover:text-purple-400 transition-all duration-300 flex items-center space-x-1 px-3 py-2 rounded-lg hover:bg-purple-500/10 hover:shadow-lg hover:shadow-purple-500/20 transform nav-link-hover">
                  <div className="relative">
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="relative group" data-dropdown>
              ...
              <div
                ...
                className="absolute right-0 mt-2 w-48 bg-gray-800/95 backdrop-blur-sm rounded-md shadow-lg border border-gray-700"
              >
                <a href="https://github.com/kubestellar/kubestellar" className="flex items-center px-4 py-2 text-sm text-gray-300 hover:bg-emerald-900/30 rounded transition-all duration-200 hover:text-emerald-300 hover:shadow-md">
                ...
                <a href="https://github.com/kubestellar/kubestellar/fork" className="flex items-center px-4 py-2 text-sm text-gray-300 hover:bg-emerald-900/30 rounded transition-all duration-200 hover:text-emerald-300 hover:shadow-md">
                ...
                <a href="https://github.com/kubestellar/kubestellar/watchers" className="flex items-center px-4 py-2 text-sm text-gray-300 hover:bg-emerald-900/30 rounded transition-all duration-200 hover:text-emerald-300 hover:shadow-md">
