...
export default function ContactSection() {
  ...
  return (
    <section id="contact" className="relative py-20 bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 text-white overflow-hidden">
      ...
      <div id="stars-container-contact" className="absolute inset-0 overflow-hidden"></div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-12">
          ...
          <p className="mt-4 max-w-2xl mx-auto text-xl text-gray-300">
            Ready to transform your multi-cluster operations? Let&apos;s connect and explore how KubeStellar can help.
          </p>
        </div>
            ...
            <div className="space-y-6">
              <div className="flex items-start space-x-4 group">
                ...
                <div>
                  ...
                  <p className="text-gray-300">Join our Slack workspace for real-time support</p>
                  <a href="#" className="inline-flex items-center mt-2 text-blue-400 hover:text-blue-300 transition-colors">
                    Join Slack
              ...
              <div className="flex items-start space-x-4 group">
                ...
                <div>
                  ...
                  <p className="text-gray-300">Contribute, report issues, or browse the source code</p>
                  <a href="#" className="inline-flex items-center mt-2 text-green-400 hover:text-green-300 transition-colors">
                    View Repository
                    <svg className="w-4 h-4 ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" />
                    </svg>
              ...
              <div className="flex items-start space-x-4 group">
                ...
                <div>
                  ...
                  <p className="text-gray-300">Get direct support from our team</p>
                  <a href="mailto:support@kubestellar.io" className="inline-flex items-center mt-2 text-purple-400 hover:text-purple-300 transition-colors">
            ...
            <div className="bg-gradient-to-br from-gray-800/50 to-gray-900/50 backdrop-blur-sm rounded-xl p-6 border border-gray-700/50">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="text-center">
                  <div className="text-2xl font-bold text-blue-400 counter" data-target="2500">0</div>
                  <div className="text-sm text-gray-400">GitHub Stars</div>
                </div>
                <div className="text-center">
                  <div className="text-2xl font-bold text-green-400 counter" data-target="150">0</div>
                  <div className="text-sm text-gray-400">Contributors</div>
                </div>
                <div className="text-center">
                  <div className="text-2xl font-bold text-purple-400 counter" data-target="500">0</div>
                  <div className="text-sm text-gray-400">Slack Members</div>
                </div>
                <div className="text-center">
                  <div className="text-2xl font-bold text-yellow-400 counter" data-target="50">0</div>
