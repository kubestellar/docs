...
export default function AboutSection() {
    ...
    const initFeatureCards = () => {
      ...
      featureCards.forEach((card, index) => {
        ...
        cardElement.addEventListener('mouseenter', () => {
          cardElement.style.transform = 'perspective(1000px) rotateY(5deg) rotateX(5deg) translateZ(20px)';
        });
  ...
  return (
    <section id="about" className="relative py-24 bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 text-white overflow-hidden">
      {/* Dark base background */}
      <div className="absolute inset-0 bg-[#0a0a0a]"></div>
      
      {/* Starfield background */}
      <div id="stars-container-about" className="absolute inset-0 overflow-hidden"></div>
        ...
        <div className="mt-20 grid gap-10 lg:grid-cols-3 feature-cards">
          ...
          <div className="feature-card relative group perspective bg-gradient-to-br from-gray-800/50 to-gray-900/50 backdrop-blur-sm rounded-xl p-8 border border-gray-700/50 transition-all duration-300">
            ...
            <div className="relative z-10">
              ...
              <h3 className="text-xl font-semibold text-white mb-4">Unified Management</h3>
              <p className="text-gray-300 leading-relaxed">
                Manage multiple Kubernetes clusters from a single control plane. Deploy, monitor, 
                and maintain workloads across hybrid and multi-cloud environments with ease.
              </p>
          ...
          <div className="feature-card relative group perspective bg-gradient-to-br from-gray-800/50 to-gray-900/50 backdrop-blur-sm rounded-xl p-8 border border-gray-700/50 transition-all duration-300">
            ...
            <div className="relative z-10">
              ...
              <h3 className="text-xl font-semibold text-white mb-4">Intelligent Distribution</h3>
              <p className="text-gray-300 leading-relaxed">
                Automatically distribute workloads based on resource availability, geographic constraints, 
                and business policies. Optimize performance and reduce costs with smart placement.
              </p>
          ...
          <div className="feature-card relative group perspective bg-gradient-to-br from-gray-800/50 to-gray-900/50 backdrop-blur-sm rounded-xl p-8 border border-gray-700/50 transition-all duration-300">
            ...
            <div className="relative z-10">
              ...
              <p className="text-gray-300 leading-relaxed">
                Built-in security controls, policy enforcement, and compliance monitoring. 
                Ensure your multi-cluster deployments meet enterprise security standards.
              </p>
