      ...
      <div className="mx-auto max-w-6xl text-center">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
          ...
          <div className="bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-white/10 hover:border-white/20 transition-all duration-300 hover:transform hover:scale-105">
            ...
            <h3 className="text-lg font-semibold text-white mb-2">{t("cta.documentsButton")}</h3>
            <p className="text-gray-400 text-sm mb-4">{t("cta.documentsDescription")}</p>
            <Link
              href="/docs"
          ...
          <div className="bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-white/10 hover:border-white/20 transition-all duration-300 hover:transform hover:scale-105">
            ...
            <h3 className="text-lg font-semibold text-white mb-2">{t("cta.quickStartButton")}</h3>
            <p className="text-gray-400 text-sm mb-4">{t("cta.quickStartDescription")}</p>
            <Link
          ...
          <div className="bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-white/10 hover:border-white/20 transition-all duration-300 hover:transform hover:scale-105">
            ...
            <h3 className="text-lg font-semibold text-white mb-2">{t("cta.communityButton")}</h3>
            <p className="text-gray-400 text-sm mb-4">{t("cta.communityDescription")}</p>
            <a
