      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        <div className="mt-8 flex flex-col sm:flex-row gap-6 justify-center items-center">
          ...
          >
            ...
            <span className="relative z-10">{t("communityMeetingsButton")}</span>
        ...
        <div className="mt-12 grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-4xl mx-auto">
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 border border-white/20 hover:bg-white/20 transition-colors duration-300">
            ...
            <h3 className="text-lg font-bold mb-2 text-center">{t("exploreCodeTitle")}</h3>
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 border border-white/20 hover:bg-white/20 transition-colors duration-300">
            ...
            <h3 className="text-lg font-bold mb-2 text-center">{t("joinSlackTitle")}</h3>
            <p className="text-sm text-blue-100 text-center mb-4">
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 border border-white/20 hover:bg-white/20 transition-colors duration-300">
            ...
            <h3 className="text-lg font-bold mb-2 text-center">{t("learnGuideTitle")}</h3>
            <p className="text-sm text-blue-100 text-center mb-4">
