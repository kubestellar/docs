...
export default function HeroSection() {
  useEffect(() => {
    ...
    const initTypingAnimation = () => {
      ...
      const commandResponse = document.querySelector('.command-response') as HTMLElement;
    ...
    const missionControlScene = document.querySelector('.mission-control-scene') as HTMLElement;
    
    if (sceneContainer && missionControlScene) {
      // Initial animation to bring the scene into view
      setTimeout(() => {
        sceneContainer.style.transform = 'perspective(1000px) rotateY(3deg) rotateX(2deg) translateZ(0)';
  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 text-white min-h-[85vh] flex items-center">
      ...
      <div className="absolute inset-0 z-0">
        ...
        <div className="absolute inset-0">
          <canvas id="grid-canvas" className="w-full h-full opacity-20"></canvas>
        </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-20">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center min-h-[70vh]">
          ...
          <div className="hero-content space-y-6">
            ...
            <div className="status-badge-container animate-fade-in-up" style={{animationDelay: '0.2s'}}>
              <div className="inline-flex items-center px-4 py-2 rounded-full bg-gradient-to-r from-green-500/20 to-blue-500/20 border border-green-500/30 animate-status-glow">
                ...
                <span className="text-sm font-medium text-green-400">Platform Status: Operational</span>
              </div>
            </div>
            
            {/* Dynamic Main Heading */}
            <div className="heading-container space-y-4 animate-text-reveal" style={{animationDelay: '0.4s'}}>
              ...
              <p className="text-xl md:text-2xl text-gray-300 leading-relaxed max-w-2xl">
                Simplify multi-cluster Kubernetes operations with intelligent workload distribution, 
                unified management, and seamless orchestration across any infrastructure.
              </p>
            </div>
            
            {/* Interactive Command Center */}
            <div className="command-center-container animate-slide-in-left" style={{animationDelay: '0.6s'}}>
              <div className="bg-gray-900/80 backdrop-blur-sm rounded-lg border border-gray-700/50 p-4 animate-command-glow">
                <div className="flex items-center mb-2">
                  ...
                  <span className="ml-4 text-gray-400 text-sm">KubeStellar Terminal</span>
                </div>
                <div className="font-mono text-sm">
                  <div className="text-green-400">
                    $ kubectl apply -f kubestellar-deployment.yaml
                  </div>
                  <div className="command-response text-blue-400 mt-2" style={{opacity: 0}}>
                    ✅ Deployment successfully distributed to 5 clusters
                    <br />
                    📊 Monitoring workload health across regions
                    <br />
                    <span className="text-green-400">🚀 KubeStellar is ready!</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="action-buttons-container flex flex-col sm:flex-row gap-4 animate-fade-in" style={{animationDelay: '0.8s'}}>
            ...
            <div className="stats-dashboard grid grid-cols-1 sm:grid-cols-3 gap-4 pt-6 animate-fade-in" style={{animationDelay: '1s'}}>
              <div className="stat-card stat-card-1 relative bg-gray-800/50 backdrop-blur-sm rounded-lg p-4 border border-gray-700/50 hover-lift animate-stat-float">
                ...
                <div className="relative z-10">
                  <div className="text-2xl font-bold text-green-400 counter" data-target="50">0</div>
              ...
              <div className="stat-card stat-card-2 relative bg-gray-800/50 backdrop-blur-sm rounded-lg p-4 border border-gray-700/50 hover-lift animate-stat-float">
                <div className="stat-glow"></div>
                <div className="relative z-10">
                  <div className="text-2xl font-bold text-pink-400 counter" data-target="1000">0</div>
              ...
              <div className="absolute inset-0 flex items-center justify-center astronaut-container">
                <div className="relative astronaut">
                  <svg width="120" height="120" viewBox="0 0 120 120" className="drop-shadow-2xl">
                    {/* Helmet */}
                    <circle cx="60" cy="45" r="25" fill="url(#helmet-gradient)" stroke="#3b82f6" strokeWidth="2"/>
                    
                    {/* Helmet Visor */}
                    <path d="M 40 45 Q 60 25 80 45 Q 60 65 40 45" fill="url(#visor-gradient)" opacity="0.8"/>
                    
                    {/* Body */}
                    <path d="M 45 70 L 75 70 L 78 95 L 42 95 Z" fill="url(#suit-gradient)" stroke="#6366f1" strokeWidth="1"/>
                    
                    {/* Arms */}
                    <path d="M 45 75 L 30 85 L 35 90 L 50 80" fill="url(#suit-gradient)" stroke="#6366f1" strokeWidth="1"/>
                    <path d="M 75 75 L 90 85 L 85 90 L 70 80" fill="url(#suit-gradient)" stroke="#6366f1" strokeWidth="1"/>
                    
                    {/* Control Device */}
                    <circle cx="85" cy="87" r="4" fill="#10b981" className="pulsing"/>
