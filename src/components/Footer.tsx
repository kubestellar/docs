        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-8 mb-12">
          ...
          <div className="lg:col-span-4">
            ...
            <div className="flex space-x-4">
              ...
              <a
                href="#"
                className="w-10 h-10 bg-gray-700 hover:bg-purple-600 rounded-lg flex items-center justify-center transition-colors duration-300"
              >
                <svg
                  className="w-7 h-7"
                  fill="currentColor"
              ...
              <a
                href="#"
                className="w-10 h-10 bg-gray-700 hover:bg-blue-500 rounded-lg flex items-center justify-center transition-colors duration-300"
              >
                <svg
                  className="w-7 h-7"
                  fill="currentColor"
              ...
              <a
                href="#"
                className="w-10 h-10 bg-gray-700 hover:bg-red-600 rounded-lg flex items-center justify-center transition-colors duration-300"
              >
                <svg
                  className="w-7 h-7"
                  fill="currentColor"
            ...
            <div className="border border-gray-700 bg-[#161A23] rounded-xl p-6">
              <form action="" className="space-y-6">
                <div className="relative ">
                  ...
                  <input type="email" placeholder="Enter your email address" className=" w-full bg-[#252C39] border border-gray-700 rounded-lg py-5 text-wrap pl-10 pr-4 text-white placeholder-gray-400 focus:ring-purple-500 focus:border-purple-500 transition" />
                </div>
