...
export const PROJECTS: Record<ProjectId, ProjectConfig> = {
  ...
  a2a: {
    ...
    navPath: "docs/content/a2a/nav.yaml",
  ...
  kubeflex: {
    ...
    navPath: "docs/content/kubeflex/nav.yaml",
  ...
  "multi-plugin": {
    ...
    navPath: "docs/content/multi-plugin/nav.yaml",
  ...
  "console": {
    ...
    navPath: "docs/content/console/nav.yaml",
