    ...
    extend: {
      ...
      keyframes: {
        ...
        shootingStar: {
          ...
          '2%': { opacity: '1', transform: 'translateX(0) translateY(0) scale(1)' },
          '7%': { opacity: '1' },
          '9%': { opacity: '0', transform: 'translateX(300px) translateY(-100px) scale(0)' },
          '100%': { opacity: '0', transform: 'translateX(300px) translateY(-100px) scale(0)' },
        },
        'nebula-float': {
