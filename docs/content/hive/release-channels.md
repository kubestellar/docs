> **Synced from Hive.** This page is pulled from [kubestellar/hive@v4](https://github.com/kubestellar/hive/blob/v4/src/docs/release-channels.md) during the docs build. Edit the canonical source in the Hive repository.
